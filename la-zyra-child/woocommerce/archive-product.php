...
// $result= $wpdb->get_results("SELECT * FROM $wpdb->postmeta WHERE meta_key='_regular_price' LIMIT 9");
...
$catalog_column = LA_Zyra()->settings->get('woocommerce_catalog_columns', LA_Zyra()->settings->get('woocommerce_shop_page_columns'));
...
if ( have_posts() ) {
	...
	<div id="la_shop_products" class="la-shop-products">
		<div class="text-center hidden load-div"><img src="http://haveago.city/wp-content/uploads/2018/11/loader.gif" class="loading" /></div>
		...
		wc_set_loop_prop('is_main_loop', tru);
	...
	get list of all the taxonomies
