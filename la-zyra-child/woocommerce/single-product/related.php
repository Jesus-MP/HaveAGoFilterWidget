...
if ( $related_products ) : ?>
	...
	$product_cols = shortcode_atts(
		...
		LA_Zyra()->settings->get('related_products_columns')
	);
	...
	$title = LA_Zyra()->settings->get('related_product_title') ? LA_Zyra()->settings->get('related_product_title') : _x( 'Related Products', 'front-view', 'la-zyra' );
	$sub_title = LA_Zyra()->settings->get('related_product_subtitle') ? LA_Zyra()->settings->get('related_product_subtitle') : '';
	?>
