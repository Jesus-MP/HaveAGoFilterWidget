...
if ( $upsells ) : ?>
    ...
    $product_cols = shortcode_atts(
        ...
        LA_Zyra()->settings->get('upsell_products_columns')
    );
    ...
    $title = LA_Zyra()->settings->get('upsell_product_title') ? LA_Zyra()->settings->get('upsell_product_title') : _x( 'You may also like&hellip;', 'front-view', 'la-zyra' );
    $sub_title = LA_Zyra()->settings->get('upsell_product_subtitle') ? LA_Zyra()->settings->get('upsell_product_subtitle') : '';
    ?>
